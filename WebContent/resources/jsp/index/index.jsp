...
<link rel="stylesheet" type="text/css" href="<%=contextpath %>/resources/lib/icheck/all.css" />
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a _href="<%=contextpath %>/resources/jsp/admin/admin-role.jsp" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
					<li><a _href="<%=contextpath %>/resources/jsp/admin/admin-permission.jsp" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
					<li><a _href="<%=contextpath %>/resources/jsp/admin/admin-list.jsp" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
